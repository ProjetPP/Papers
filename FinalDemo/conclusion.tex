...
\begin{figure}
 \begin{tikzpicture}
  ...
  \node (0) at (-1,-1) {\textcolor{mDarkTeal}{meteo}};
  ...
  \node (0) at (4,-1) {\textcolor{mMediumBrown}{literature}};
...
\begin{frame}
    ...
    \begin{column}{0.55\textwidth}
        ...
        \begin{tabular}{ll}
            ...
            \includegraphics[width=\logosize]{ic_email_black_18dp.png} & \href{mailto:askplatyp.us}{ppp@pony.ovh}\\
        \end{tabular}
    \end{column}
