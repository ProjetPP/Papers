\begin{frame}
    ...
    \begin{column}{0.3\textwidth}
        \only<1->{\includegraphics[width=\linewidth]{figures/platypus.png}}
    \end{column}
    \begin{column}{0.4\textwidth}
        \only<2->{\center \Huge VS}
    \end{column}
    \begin{column}{0.3\textwidth}
        \only<3->{\includegraphics[width=\linewidth]{figures/wa-logo-stacked2-large.png}}
    \end{column}
    \end{columns}
\end{frame}
