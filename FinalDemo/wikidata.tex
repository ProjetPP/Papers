...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item a sister project of Wikipedia
...
\begin{frame}
  \frametitle{Answer extraction: Question}
    What is the residence of the prime minister of the United Kingdom?
\end{frame}

\begin{frame}
  \frametitle{Answer extraction: Intermediate representation}
