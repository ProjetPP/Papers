...
Abstract & \emph{Projet Pensées Profondes} aims to build a project about natural language question answering framework.
...
inline
    ...
    \ganttbar[name = WP2]{Software architecture}{1}{24} \\
