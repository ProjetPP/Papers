...
questions in plain text throw a web user interface, a core module able to transform
this question into a normal form and one demo backend module able to answer
to historical questions using Wikidata data.

We expect also to have done some research on natural languages analysis using
neuronal networks. These researches may lead, if they are successful, to
