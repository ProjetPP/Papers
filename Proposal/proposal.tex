...
\begin{center}
	\begin{tabular}{lll}
		...
		WP1 & System administration & Valentin\\
		WP2 & Software architecture & Thomas\\
...
Several workpackages are defined for this project, with specific goal and and
participants. They are detailed on the following.

\begin{workpackage}
Global organization

Person in charge: Marc.
...
Person in charge: Yassine.

Referencement of the used ressources, e.g. papers, libraries.
\end{workpackage}
