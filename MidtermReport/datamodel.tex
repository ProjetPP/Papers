...
\begin{itemize}
    \item \texttt{accuracy} is a self-rating of how much the module may have correctly understood (i.e. not misinterpreted) the request/question. It is a float between 0 and 1.
