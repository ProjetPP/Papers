...
\begin{itemize}
    \item for subject: $\textsl{exists}_{\textsl{subject}}(a,b) = \exists x : (x,a,b) = ((x,a,b) \neq \emptyset)$
    \item for predicate: $\textsl{exists}_{\textsl{predicate}}(a,b) = \exists x : (a,x,b) = ((a,x,b) \neq \emptyset)$
    \item for object: $\textsl{exists}_{\textsl{object}}(a,b) = \exists x : (a,b,x) = ((a,b,x) \neq \emptyset)$
\end{itemize} 
