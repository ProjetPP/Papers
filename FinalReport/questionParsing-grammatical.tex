...
\begin{figure}
  ...
  \begin{center}
    \begin{tikzpicture}
      \node (0) at (8.5,9.5) {\textit{When did Diana and Charles get married?}};
      \node (1) at (9,9) {$\cap$};
      \node (2) at (6.5,8) {$\triple$};
      \node (3) at (4.5,6.5) {Diana};
      \node (4) at (6.5,6.5) {marriage date};
      \node (5) at (8,6.5) {?};
      \node (6) at (11.5,8) {$\triple$};
      \node (7) at (9.5,6.5) {Charles};
      \node (8) at (11.5,6.5) {marriage date};
      \node (9) at (13,6.5) {?};
