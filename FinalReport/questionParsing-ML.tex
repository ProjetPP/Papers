...
\begin{center}
  ...
  \node[color=red] (1) at (10,8.5) {president};
  \node (2) at (12,8.5) {?};
  \node (3) at (8,8.5) {$\triple$};
  \node (4) at (8,7) {United States};
  \node[color=red] (5) at (5,7) {birth date};
  \node (6) at (10,7) {?};
  ...
  \draw[<->, >= latex,color=red] [draw=red] [bend right=50, above] (1) edge (5);
