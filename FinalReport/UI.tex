We decided to implement, at first, only a web user interface. This interface
...
the query and another one to get a random question from an hand written list. The text area
